...
|---|---|---|---|---|
| `contenido-web-corrales-de-rota.md` | activo | alta | Volcado íntegro de la web oficial en Google Sites (loscorralesderota.com), recopilado el 2026-07-22 por la asociación: datos de la organización (CIF G72275449, lema, nota de transparencia «100 % de la recaudación a conservación»), historia y fundación de la asociación (registro nº 11.400 del 4-6-2014, reinscripción 11-1-11400 del 17-9-2018), fines estatutarios, convenio con el Ayuntamiento del 17-3-2015 (nombra los 6 corrales: San Clemente, Chico, En Medio, Hondo, Punta Candor y Corraleata), actividades, reconocimientos (Premio Medioambiente Rota 2015, XXI Premio Andalucía de Medioambiente 2017), textos de Monumento Natural, «Descubre los corrales» (las 8 joyas), visita y normas, y las páginas legales. Ya minado para `content/es/*.json` (aviso legal, privacidad, monumento-natural, visita, joyas). **Sin portar todavía a la web v1:** (a) página de **mareas** con su aviso de exención de responsabilidad, (b) **I Concurso de Fotografía** con las 14 bases, correos `fotos@` / `fotos-socios@` y plazo del 15 de agosto, (c) política de cookies. | 2026-07-24 |
